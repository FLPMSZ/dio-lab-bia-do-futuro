...
| `produtos_financeiros.json` | JSON | Conhecer os produtos disponíveis para que eles possam ser explicados para o cliente. |
...
O produto Fundo Imobiliário(FII) substitutiu o produto: Fundo Multimercado, pois me sinto mais seguro usando produtos financeiros que eu conheço. Assim, poderei validar as respostas do Nico de forma mais assertiva.
...
HISTÓRICO DE ATENDIMENTO DO CLIENTE(/data
...
PRODUTOS DISPONÍVEIS PARA ENSINO(/data
